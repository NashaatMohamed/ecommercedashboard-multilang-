                    ...
                    <div class="row breadcrumbs-top">
                        <div class="breadcrumb-wrapper col-12">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item"><a href="{{route("admin.vendor")}}"> المتاجر الرئيسية </a>
                                </li>
                        ...
                        <div class="col-md-12">
                            <div class="card">
                                <div class="card-header">
                                    <h4 class="card-title" id="basic-layout-form"> تعديل متجر رئيسي </h4>
                                        ...
                                        <form class="form" action="{{route("admin.vendor.update",$vendor->id)}}" method="POST"
                                            ...
                                            <div class="form-group">
                                                <div class="text-center">
                                                    <img
                                                        src="{{$vendor -> logo}}"
                                                        class="rounded-circle  height-300" alt="لوجو التاجر">
                                                </div>
                                            <div class="form-group">
                                            ...
                                            <div class="form-body">
                                                                ...
                                                                <optgroup label="من فضلك أختر القسم ">
                                                                    @if($categories && $categories -> count() > 0)
                                                                        @foreach($categories as $category)
                                                                            <option
                                                                                value="{{$category->id}}" @if($category->id == $vendor->category_id) selected @endif >{{$category -> name}}</option>
                                                                        @endforeach
                                                                    @endif
                                                                </optgroup>
                                                            </select>
                                                ...
                                                <div class="row">
                                                    <div class="col-md-6">
                                                        <div class="form-group ">
                                                            <label for="projectinput1">  الايميل الالكترونى</label>
                                                            <input type="text" value="{{$vendor->email}}" id="name"
                                                                   class="form-control"
                                                                   placeholder="  "
                                                                   name="email">
                                                            @error("email")
