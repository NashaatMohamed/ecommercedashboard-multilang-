                                ...
                                <div class="card-content collapse show">
                                    <div class="card-body">
                                        <form class="form" action="{{route("admin.mainCategory.update",$mainCategory->id)}}" method="POST"
                                            ...
                                            <div class="form-group">
                                                ...
                                                @error("photo")
                                                <span class="text-danger"> يجب ادخال الصوره </span>
                                                @enderror
                                            </div>
                                    ...
                                    <ul class="nav nav-tabs">
                                        ...
                                        <li class="nav-item @if($index == 0) active @endif">
                                            <a class="nav-link" id="homeLable-tab" data-toggle="tab" href="#homeLable{{$index}}" aria-controls="homeLable"
                                    ...
                                    <div class="tab-content px-1 pt-1">
                                        ...
                                        <div role="tabpanel" class="tab-pane @if($index == 0) active @endif" id="homeLable{{$index}}" aria-labelledby="homeLable-tab"
                                             aria-expanded="{{$index == 0 ? "true" : "false"}}">
                                            <form class="form" action="{{route("admin.mainCategory.update",$translation->id)}}" method="POST"
                                                  enctype="multipart/form-data">
                                                @csrf
                                                <input name="id" value="{{$mainCategory->id}}" type = "hidden">
